    ...
    <main className="container">
        ...
        <>
          ...
          <ul className="task-list">
            ...
            {filteredTasks.length === 0 && (
              <li className="empty-state">No hay tareas para este filtro.</li>
            )}
          </ul>
        </>
      )}
      ...
      {taskToDelete && (
        <div
          ...
          onMouseDown={(event) =>
            onOverlayMouseDown(event, () => setTaskToDelete(null))
          }
        >
          <div className="modal-card">
            <h2>Eliminar tarea</h2>
            <p>
              Vas a eliminar <strong>{taskToDelete.title}</strong>. Esta accion
      ...
      {confirmAction && (
        <div
          ...
          onMouseDown={(event) =>
            onOverlayMouseDown(event, () => setConfirmAction(null))
          }
        >
